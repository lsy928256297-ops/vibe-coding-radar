...
const skillRadarUrl = "/skills.html?v=weekly-refresh-20260708";
...
const projectSkillOverrides = {
  ...
  "usestrix/strix": ["github-cli", "skillspector", "playwright-skill"],
  "msitarzewski/agency-agents": ["agent-skills", "github-cli", "document-skills"],
  "JuliusBrussee/caveman": ["openai-skills", "github-cli", "document-skills"],
  "Zackriya-Solutions/meetily": ["github-cli", "huggingface-skills", "document-skills"],
  "hasaneyldrm/exercises-dataset": ["github-cli", "shadcn-skill", "playwright-skill"],
  "xbtlin/ai-berkshire": ["github-cli", "document-skills", "openai-docs"],
  "diegosouzapw/OmniRoute": ["github-cli", "openai-docs", "playwright-skill"],
  "ogulcancelik/herdr": ["github-cli", "openai-skills", "document-skills"],
  "openai/codex-plugin-cc": ["openai-skills", "github-cli", "document-skills"],
  "alibaba/page-agent": ["github-cli", "playwright-skill", "opencli"],
  "asgeirtj/system_prompts_leaks": ["document-skills", "github-cli", "skillspector"],
};
...
const githubTrendingUpdatedAt = new Date("2026-07-08T02:45:00+08:00");

const githubStarProjects = [
  {
    repo: "usestrix/strix",
    name: "usestrix/strix",
    tagline: "开源 AI 渗透测试工具，帮你找出应用漏洞并给出修复建议，本周增长最快。",
    language: "Python",
    totalStars: 38464,
    weeklyStars: 10759,
    trendingRank: 1,
    mvp: "先拿自己写的 demo 或练习仓库做一次安全扫描，只看漏洞列表、修复建议和复测结果。",
    wow: 91,
    useful: 94,
    easy: 68,
  ...
  },
  {
    ...
    tagline: "一整套“AI agency”角色库，从前端、社区运营到现实检查员，适合给 Codex 配团队。",
    language: "Shell",
    totalStars: 128698,
    weeklyStars: 9706,
    trendingRank: 11,
    mvp: "挑 3 个最常用 agent 角色，让它们分别做需求、页面、验收，比较多 agent 协作是否真的省心。",
    wow: 92,
    useful: 89,
    easy: 77,
  ...
  },
  {
    ...
    tagline: "Claude Code Skill，用极简表达压缩上下文，据称能显著减少 token 消耗。",
    language: "JavaScript",
    totalStars: 86169,
    weeklyStars: 7780,
    trendingRank: 17,
    mvp: "拿同一个 issue 让 Codex 跑普通提示词和压缩提示词，对比信息损失、速度和可读性。",
    wow: 88,
    useful: 87,
    easy: 82,
  ...
  },
  {
    ...
    tagline: "本地优先 AI 会议助手，支持实时转写、说话人区分和本地 Ollama 总结。",
    language: "Rust",
    totalStars: 20447,
    weeklyStars: 5769,
    trendingRank: 2,
    mvp: "先用一段会议录音跑通转写、说话人分离和 5 条待办摘要，不接云服务。",
    wow: 83,
    useful: 95,
    easy: 66,
  ...
  },
  {
    ...
    tagline: "433 个健身动作数据集，包含肌群、器械、说明、缩略图和动作视频。",
    language: "HTML",
    totalStars: 10669,
    weeklyStars: 5665,
    trendingRank: 3,
    mvp: "用数据集做一个健身动作筛选器：按肌群、器械和难度过滤，并展示动图。",
    wow: 78,
    useful: 88,
    easy: 84,
  ...
  },
  {
    ...
    tagline: "面向 Claude Code / Codex 的价值投资研究框架，用多 agent 做公司研究和交叉质询。",
    language: "Python",
    totalStars: 11636,
    weeklyStars: 4616,
    trendingRank: 10,
    mvp: "不做投资建议，先用公开财报样本生成一页公司研究卡：业务、风险、争议和待验证问题。",
    wow: 80,
    useful: 86,
    easy: 63,
  ...
  },
  {
    ...
    tagline: "免费 AI 网关，把 Claude Code、Codex、Cursor 等接到多模型、多 provider 和自动 fallback。",
    language: "TypeScript",
    totalStars: 13042,
    weeklyStars: 4594,
    trendingRank: 5,
    mvp: "做一个本地模型路由 demo：同一条提示词走两个 provider，并显示响应时间和失败切换。",
    wow: 87,
    useful: 91,
    easy: 64,
  ...
  },
  {
    ...
    tagline: "终端里的 agent multiplexer，把多个 coding agent 统一成一个可切换工作台。",
    language: "Rust",
    totalStars: 13393,
    weeklyStars: 4348,
    trendingRank: 4,
    mvp: "接入两个本地 coding agent，做一次同题对比：一个读项目，一个给修复建议。",
    wow: 84,
    useful: 88,
    easy: 65,
  ...
  },
  {
    ...
    tagline: "OpenAI 官方插件，让 Claude Code 直接调用 Codex 做代码审查、委派任务和交叉验证。",
    language: "JavaScript",
    totalStars: 26574,
    weeklyStars: 4329,
    trendingRank: 7,
    mvp: "在一个小仓库里让 Claude Code 委派 Codex 审查改动，再对比两边发现的问题。",
    wow: 86,
    useful: 92,
    easy: 76,
  ...
  },
  {
    ...
    tagline: "公开整理多家 AI 产品的系统提示词样本，适合做提示词安全和边界意识的阅读材料。",
    language: "JavaScript",
    totalStars: 52748,
    weeklyStars: 4290,
    trendingRank: 20,
    mvp: "只做安全阅读器：把公开样本按产品、能力边界和风险提示归类，不复刻抓取或绕过流程。",
    wow: 78,
    useful: 76,
    easy: 80,
  ...
  },
  {
    ...
    tagline: "阿里开源的网页 GUI agent，在页面内用自然语言控制按钮、输入框和交互流程。",
    language: "TypeScript",
    totalStars: 24864,
    weeklyStars: 3989,
    trendingRank: 6,
    mvp: "接一个简单表单页，让 agent 完成搜索、填写、提交和结果校验四步。",
    wow: 90,
    useful: 90,
    easy: 70,
...
const projectTagOverrides = {
  ...
  "usestrix/strix": ["AI 安全扫描", "漏洞修复", "本周最快"],
  "msitarzewski/agency-agents": ["Agent 团队", "角色库", "多工协作"],
  "JuliusBrussee/caveman": ["省 Token", "提示词压缩", "Claude Skill"],
  "Zackriya-Solutions/meetily": ["本地会议助手", "实时转写", "Ollama 总结"],
  "hasaneyldrm/exercises-dataset": ["健身数据集", "动作筛选", "视频素材"],
  "xbtlin/ai-berkshire": ["投资研究", "多 Agent", "公开财报"],
  "diegosouzapw/OmniRoute": ["AI 网关", "模型路由", "自动 fallback"],
  "ogulcancelik/herdr": ["Agent 切换", "终端工作台", "多代理"],
  "openai/codex-plugin-cc": ["官方插件", "Codex 协作", "代码审查"],
  "asgeirtj/system_prompts_leaks": ["提示词安全", "边界意识", "公开样本"],
  "alibaba/page-agent": ["网页操作", "GUI agent", "自然语言控制"],
